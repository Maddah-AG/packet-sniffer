    ...
    while True:
        ...
        if eth_proto == 8:
            ...
            if proto == 17:
                ...
                print(TAB_1 + 'UDP Segment:')
                print(TAB_2 + 'Source Port: {}, Destination Port: {}, Length: {}'.format(src_port, dest_port, length))
                print(TAB_3 + 'UDP Data: {}'.format(data))
...
def tcp_seg(data):
    (src_port, dest_port, sequence, acknowledgenment, offset_reserved_flag) = struct.unpack('! H H L L H', data[:14])
    ...
    return src_port, dest_port, sequence, acknowledgenment, flag_urg, flag_ack, flag_psh, flag_rst, flag_syn, flag_fin, data
